export seqassim_project_mass_toy_problem


"""
seqassim_project_mass_toy_problem(F::StateSpace, data::SyntheticData, J::Int64, ϵx::InflationType, algo::SeqFilter, X, Ny, Nx, t0::Float64, Aop::MatrixOperator)
...
"""
function seqassim_project_mass_toy_problem(F::StateSpace, data::SyntheticData, J::Int64, ϵx::InflationType, 
                                           Uperp::Union{Vector{Float64}, Matrix{Float64}}, algo::SeqFilter, 
